...
# Código principal - SOLO TU DANIELKPI ORIGINAL
df = load_data()
...
if df is not None:
    ...
    income_col = 'Income'  # Asumiendo que existe esta columna
    ...
    if income_col in df.columns:
        ...
        # Pestaña 1: Scatter plot - TU CÓDIGO ORIGINAL
        with tab1:
        ...
        # Pestaña 2: Histograma de ingresos - TU CÓDIGO ORIGINAL
        with tab2:
        ...
        # Pestaña 3: Boxplot por quintiles - TU CÓDIGO ORIGINAL
        with tab3:
        ...
        # Sección de conclusiones - TU CÓDIGO ORIGINAL
        st.markdown("---")
